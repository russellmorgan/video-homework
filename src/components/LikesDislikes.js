    ...
    return (
      <div className="social">
        ...
        <div className="social__likes">
          <button type="button" id="btn-like" onClick={this.onLikeDislike}>
            LIKE THIS VIDEO ({this.state.likes})
          </button>
          <button type="button" id="btn-dislike" onClick={this.onLikeDislike}>
            DISLIKE THIS VIDEO ({this.state.dislikes})
          </button>
        </div>
      </div>
    );
